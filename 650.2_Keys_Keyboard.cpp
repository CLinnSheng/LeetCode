...
using namespace std;
/*
Initially there is only on character, everytime we only allow to copy all the
characters on the screen So we need to find the minimum number of times to get
the number of characters to n times Intuition: Backtracking and dp (to reduce
time complexity)
*/
class Solution {
public:
