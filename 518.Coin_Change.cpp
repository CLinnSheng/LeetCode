 ...
 *
 * Intution:
 * Use brute force dfs where at each amount we have 3 choices
 * this will lead to time complexity of (3^n)
 * We can optimize this by using dynamic programming and memoziation so that we can skip overlapping subproblem
 * */
class Solution
{
  public:
